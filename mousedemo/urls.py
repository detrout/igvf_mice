...
router.register(r"sample-extraction", views.SampleExtractionViewSet)
router.register(r"parse-fixed-sample", views.ParseFixedSampleViewSet)
router.register(r"nucleic-acid-extraction", views.NucleicAcidExtractionViewSet)
router.register(r"nanopore-library", views.NanoporeLibraryViewSet)
